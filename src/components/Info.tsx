		...
		<section className="bg-gray-100 font-poppins pb-32">
			...
			<div className='flex justify-center items-center flex-col mx-6 md:flex-row md:mx-4'>
				...
				>
					<div>
						<div
							className='mt-[-2rem] rounded-full bg-primary-dark-violet p-4 w-16
				...
				<div
					className='flex flex-col items-center md:mt-24 bg-white rounded-lg w-full h-fit
					md:w-1/3 md:items-start lg:w-1/4'
				>
					<div>
						<div
							className='mt-[-2rem] rounded-full bg-primary-dark-violet p-4 w-16
				...
				<div
					className='flex flex-col items-center md:mt-36 bg-white rounded-lg w-full
					h-fit md:w-1/3 md:items-start lg:w-1/4'
				>
					<div>
						<div
