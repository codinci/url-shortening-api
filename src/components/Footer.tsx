...
export const Footer = () => {
	...
	return (
		<footer className='bg-neutral-very-dark-blue text-white font-poppins'>
			<div className='flex justify-around items-center flex-col pt-8 md:flex-row'>
				<div>
				...
				<div className='mt-8 text-center md:text-start md:mt-16'>
					<h1 className='m-2 font-extrabold text-lg'>Features</h1>
					<ul className='mt-2 mx-2 font-thin'>
						<li className='pt-1 hover:text-primary-cyan cursor-pointer'>Link Shortening</li>
						<li className='pt-1 hover:text-primary-cyan cursor-pointer'>Branded Links</li>
						<li className='pt-1 hover:text-primary-cyan cursor-pointer'>Analytics</li>
					</ul>
				</div>
				<div className='mt-8 text-center md:text-start md:mt-16'>
					<h1 className='m-2 font-extrabold text-lg'>Resources</h1>
					<ul className='mt-2 mx-2 font-thin'>
						<li className='pt-1 hover:text-primary-cyan cursor-pointer'>Blog</li>
						<li className='pt-1 hover:text-primary-cyan cursor-pointer'>Developers</li>
						<li className='pt-1 hover:text-primary-cyan cursor-pointer'>Support</li>
					</ul>
				</div>
				<div className='mt-8 text-center md:text-start md:mt-16'>
					<h1 className='m-2 font-extrabold text-lg'>Company</h1>
					<ul className='mt-2 mx-2 font-thin'>
						<li className='pt-1 hover:text-primary-cyan cursor-pointer'>Our Team</li>
						<li className='pt-1 hover:text-primary-cyan cursor-pointer'>Careers</li>
						<li className='pt-1 hover:text-primary-cyan cursor-pointer'>Contact</li>
					</ul>
				</div>
				<div className='flex justify-between gap-4 mt-8 md:mt-0'>
					<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24"
						className='fill-white hover:fill-primary-cyan cursor-pointer'>
